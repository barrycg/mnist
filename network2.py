# -*- coding: utf-8 -*-
"""
Created on Sun Jul 14 09:18:29 2019

a improved version of network, adding features like cross-entropy neural cost function,regularization,
better initialization of the network weights.
...
class CrossEntropyCost(object):
    ...
    @staticmethod
    def fn(a, y):
        return np.sum(np.nan_tonum(-y)*np.log(a) -(1-y)*np.log(1-a))
...
def load(filename):
    ...
    data = json.load(f)
    f.close()
    cost = getattr(sys.modules[__name__], data["data"])
